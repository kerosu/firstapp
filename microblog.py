...
@app.route('/Article')
def Article():
	return render_template('Article.html',src='../uploads/adj.jpeg' )
@app.route('/Article1')
def Article1():
	return render_template('Article1.html',src='../uploads/adj.jpeg' )
@app.route('/')
def index():
...
@app.route('/Airesource')
def Airesource():
	return render_template('Airesource.html')
@app.route('/Game')
def Gameoftrones():
